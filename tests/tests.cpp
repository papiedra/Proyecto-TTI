...
int MeasUpdate_01() {
    ...
    Matrix P2_res(6,6);
    P2_res(1,1)=16582.6959715575;	P2_res(1,2)=-5719.28825199721;	P2_res(1,3)=8964.61806949935;	P2_res(1,4)=50.8244747796259;	P2_res(1,5)=-13.4810430619866;	P2_res(1,6)=23.3577425895417;	
    P2_res(2,1)=-5719.28825199721;	P2_res(2,2)=24470.5956133384;	P2_res(2,3)=-1524.51749646658;	P2_res(2,4)=-4.79547930520971;	P2_res(2,5)=59.5579881259539;	P2_res(2,6)=-27.0053428783355;	
    P2_res(3,1)=8964.61806949935;	P2_res(3,2)=-1524.51749646657;	P2_res(3,3)=6451.49393109675;	P2_res(3,4)=28.0634345448404;	P2_res(3,5)=-4.1979181975556;	P2_res(3,6)=16.6474051683235;	
    P2_res(4,1)=50.8244747796259;	P2_res(4,2)=-4.79547930520973;	P2_res(4,3)=28.0634345448405;	P2_res(4,4)=0.185573800373364;	P2_res(4,5)=-0.0192929525680047;P2_res(4,6)=0.0698560703598162;	
    P2_res(5,1)=-13.4810430619866;	P2_res(5,2)=59.5579881259539;	P2_res(5,3)=-4.19791819755564;	P2_res(5,4)=-0.0192929525680046;P2_res(5,5)=0.15262865414647;	P2_res(5,6)=-0.0751701717977754;	
    P2_res(6,1)=23.3577425895417;	P2_res(6,2)=-27.0053428783355;	P2_res(6,3)=16.6474051683235;	P2_res(6,4)=0.0698560703598162;	P2_res(6,5)=-0.075170171797775;	P2_res(6,6)=0.0857884556591441;
    
    Matrix x_res(6,1);
    x_res(1,1)=7101559.88526246;	
    x_res(2,1)=1295247.37336744;	
    x_res(3,1)=12732.7865336535;	
    x_res(4,1)=575.975799741193;	
    x_res(5,1)=-3084.50652619203;	
    x_res(6,1)=-6736.08560617204;
    ...
    auto [K2, x2, P2] = MeasUpdate(x, z, g, s, G, P, 6.0);
    
	_assert(m_equals(K, K2, 1e-7));
	_assert(m_equals(x_res, x2, 1e-7));
	_assert(m_equals(P2_res, P2, 1e-7));
	return 0;
}
